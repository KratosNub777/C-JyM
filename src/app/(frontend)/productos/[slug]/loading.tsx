  ...
  return (
    <div className="grid gap-8 md:grid-cols-2">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="mt-2 h-10 w-40 animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />
        <div className="mt-4 h-24 w-full animate-pulse rounded bg-neutral-200 dark:bg-neutral-800" />
      </div>
    </div>
  )
}
