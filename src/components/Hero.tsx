...
export function Hero() {
  return (
    <section className="relative h-[420px] overflow-hidden rounded-2xl sm:h-[480px] md:h-[560px]">
      <Image
        src="https://picsum.photos/seed/cjym-apple-desk/1600/1000"
        alt=""
        fill
        priority
      ...
      <div className="relative flex h-full max-w-lg flex-col justify-center gap-5 px-6 sm:px-10 md:px-14">
        <h1 className="text-4xl font-semibold tracking-tight text-white md:text-5xl">
          Todo Apple, en un solo lugar.
        </h1>
        <p className="max-w-md text-base text-white/80">
          Importamos los productos que buscás, directo a Paraguay. Catálogo amplio, precios
          claros en USD y guaraníes.
        </p>
